  ...
  component('parcelSize', {
	...
	'<div class="w3-panel w3-card-2">'+
		...
		'<div>'+
			...
			'<br/><p id="sendParcel" class="w3-teal w3-button" ng-click="$ctrl.calcSize($ctrl.parcel)" style="cursor: pointer;">Größe beechnen</p> <p>Paketgröße:</p><pid="parcelRes"> {{$ctrl.parcel.size.cat}}</p>'+
			'</form>'+
		'</div>'+
	'</div>' ,
